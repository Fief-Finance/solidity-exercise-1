...
- Create unit tests to prove the logic in your contract.
...
After sharing the Github repository, we will have an informal call to discuss the design.

## Setup and organization

You can work on a private GitHub repo and then share it with **[Ser Lancelot](https://github.com/Ser-Lancelot)** GitHub user.
